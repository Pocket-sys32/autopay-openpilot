...
_ALLOWED_TRANSITIONS: dict[AttemptState, frozenset[AttemptState]] = {
  ...
  AttemptState.PENDING: frozenset({AttemptState.ACTION_REQUIRED, AttemptState.UNKNOWN, AttemptState.ACTIVE,
                                  AttemptState.DECLINED, AttemptState.CANCELLED, AttemptState.FAILED_DEFINITIVELY}),
