...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"ParkingAutoPayEnabled", {PERSISTENT, BOOL, "0"}},
    {"ParkingBackendBaseUrl", {PERSISTENT | DONT_LOG, STRING}},
    {"ParkingBackendCaPath", {PERSISTENT | DONT_LOG, STRING}},
    {"ParkingBackendTokenPath", {PERSISTENT | DONT_LOG, STRING}},
    {"ParkingCancelRequested", {CLEAR_ON_MANAGER_START | DONT_LOG, BOOL}},
    {"ParkingConfirmRequested", {CLEAR_ON_MANAGER_START | DONT_LOG, BOOL}},
    {"ParkingCurrentEpisode", {CLEAR_ON_MANAGER_START | DONT_LOG, STRING}},
    {"ParkingDefaultDuration", {PERSISTENT, INT, "3600"}},
    ...
    {"ParkingLicensePlate",{PERSISTENT | DONT_LOG, STRING}},
    {"ParkingMaxTotalMinor", {PERSISTENT, INT, "3000"}},
    {"ParkingNameOnCard", {PERSISTENT | DONT_LOG, STRING}},
    {"ParkingPendingConfirmation", {CLEAR_ON_MANAGER_START | DONT_LOG, JSON}},
    {"ParkingPendingPayload",{PERSISTENT | DONT_LOG, JSON}},
    ...
    {"ParkingTestParked", {CLEAR_ON_MANAGER_START | DEVELOPMENT_ONLY, BOOL, "0"}},
